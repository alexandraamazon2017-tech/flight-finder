...
export const AIRPORTS: Airport[] = [
  ...
  // Greece
  { iataCode: 'ATH', city: 'Atena', name: 'Eleftherios Venizelos', country: 'Grecia', aliases: ['athens', 'grecia', 'greece'] },
  { iataCode: 'SKG', city: 'Thessaloniki', name: 'Macedonia', country: 'Grecia', aliases: ['salonic', 'thessaloniki'] },
  { iataCode: 'HER', city: 'Creta', name: 'Heraklion', country: 'Grecia', aliases: ['crete', 'heraklion', 'iraklion'] },
  { iataCode: 'CHQ', city: 'Creta', name: 'Chania', country: 'Grecia', aliases: ['crete', 'chania', 'creta'] },
  { iataCode: 'RHO', city: 'Rodos', name: 'Diagoras', country: 'Grecia', aliases: ['rhodes', 'rodos'] },
  { iataCode: 'CFU', city: 'Corfu', name: 'Ioannis Kapodistrias', country: 'Grecia', aliases: ['corfu', 'kerkyra'] },
  { iataCode: 'MYK', city: 'Mykonos', name: 'Mykonos', country: 'Grecia', aliases: ['mykonos'] },
  { iataCode: 'JTR', city: 'Santorini', name: 'Thira', country: 'Grecia', aliases: ['santorini', 'thira'] },
  { iataCode: 'KGS', city: 'Kos', name: 'Hippocrates', country: 'Grecia', aliases: ['kos', 'cos'] },
  { iataCode: 'ZTH', city: 'Zakynthos', name: 'Dionysios Solomos', country: 'Grecia', aliases: ['zakynthos', 'zante'] },
  { iataCode: 'PVK', city: 'Lefkada', name: 'Aktion', country: 'Grecia', aliases: ['lefkada', 'preveza', 'aktio'] },
  { iataCode: 'EFL', city: 'Kefalonia', name: 'Anna Pollatou', country: 'Grecia', aliases: ['kefalonia', 'cephalonia'] },
  { iataCode: 'JSI', city: 'Skiathos', name: 'Alexandros Papadiamantis', country: 'Grecia', aliases: ['skiathos'] },
  { iataCode: 'JMK', city: 'Mykonos', name: 'Mykonos', country: 'Grecia', aliases: ['mykonos'] },
  { iataCode: 'KVA', city: 'Kavala', name: 'Megas Alexandros', country: 'Grecia', aliases: ['kavala', 'alexandroupolis'] },
  { iataCode: 'AOK', city: 'Karpathos', name: 'Karpathos', country: 'Grecia', aliases: ['karpathos'] },
  { iataCode: 'SMI', city: 'Samos', name: 'Aristarchos', country: 'Grecia', aliases: ['samos'] },
  { iataCode: 'MJT', city: 'Lesbos', name: 'Odysseas Elytis', country: 'Grecia', aliases: ['lesbos', 'mytilene', 'lesvos'] },
  { iataCode: 'GPA', city: 'Patras', name: 'Araxos', country: 'Grecia', aliases: ['patras', 'araxos'] },
  { iataCode: 'KLX', city: 'Kalamata', name: 'Kalamata', country: 'Grecia', aliases: ['kalamata'] },
  { iataCode: 'IOA', city: 'Ioannina', name: 'King Pyrros', country: 'Grecia', aliases: ['ioannina', 'janina'] },
  { iataCode: 'KZI', city: 'Kozani', name: 'Filippos', country: 'Grecia', aliases: ['kozani'] },
  { iataCode: 'LRS', city: 'Leros', name: 'Leros', country: 'Grecia', aliases: ['leros'] },
  { iataCode: 'JIK', city: 'Ikaria', name: 'Ikaria', country: 'Grecia', aliases: ['ikaria'] },
  { iataCode: 'MLO', city: 'Milos', name: 'Milos', country: 'Grecia', aliases: ['milos'] },
  { iataCode: 'PAS', city: 'Paros', name: 'Paros', country: 'Grecia', aliases: ['paros'] },
  { iataCode: 'SKU', city: 'Skyros', name: 'Skyros', country: 'Grecia', aliases: ['skyros'] },
  { iataCode: 'HEW', city: 'Atena', name: 'Helilinx (Hellinikon)', country: 'Grecia', aliases: ['athens', 'atena'] },
  // Portugal
